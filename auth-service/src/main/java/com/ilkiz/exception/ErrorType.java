...
public enum ErrorType {
    ...
    INVALID_ACTIVATE_CODE(1007, "Activate Code Bulunamdı", INTERNAL_SERVER_ERROR),
    ROLE_NOT_FOUND(1008, "Kullanıcı rolü bulunamadı", INTERNAL_SERVER_ERROR),
    KULLANICI_SILINEMEDI(1009,"Bu kullanıcı silme işlemi başarısız", INTERNAL_SERVER_ERROR);
    private int code;
